...
describe('getReceiptPreSum check', () => {
  ...
  it('check return noDiscountTotalPriceCheck', () => {
    ...
    const recieptArray =[{barcode:'ITEM000001',name:'雪碧',unit:'瓶',price:3,num:5},{barcode:'ITEM000003',name:'荔枝',
      unit:'斤',price:15,num:2.5},{barcode:'ITEM000005',name:'方便面',unit:'袋',price:4.5,num:3}];
...
describe('getReceiptInfo check', () => {
  ...
  it('check return recieptArrayCheck', () => {
    ...
    const recieptArray1 =[{barcode:'ITEM000001',name:'雪碧',unit:'瓶',price:3,num:5},{barcode:'ITEM000003',name:'荔枝',
      unit:'斤',price:15,num:2.5},{barcode:'ITEM000005',name:'方便面',unit:'袋',price:4.5,num:3}];
    const recieptArrayCheck =[{"barcode":"ITEM000001","name":"雪碧","unit":"瓶","price":3,"num":5,"sum":15},
      {"barcode":"ITEM000003","name":"荔枝","unit":"斤","price":15,"num":2.5,"sum":37.5},{"barcode":"ITEM000005","name":"方便面","unit":"袋","price":4.5,"num":3,"sum":13.5}];
...
describe('getReceiptInfo check', () => {
  ...
  it('check return discountTotalPrice', () => {
    ...
    const recieptArray =[{"barcode":"ITEM000001","name":"雪碧","unit":"瓶","price":3,"num":5,"sum":15},
      {"barcode":"ITEM000003","name":"荔枝","unit":"斤","price":15,"num":2.5,"sum":37.5},{"barcode":"ITEM000005","name":"方便面","unit":"袋","price":4.5,"num":3,"sum":13.5}];
...
describe('generateReciept', () => {
  ...
  it('should print text', () => {
    ...
    const recieptArray =[{"barcode":"ITEM000001","name":"雪碧","unit":"瓶","price":3,"num":5,"sum":12},{"barcode":"ITEM000003","name":"荔枝","unit":"斤","price":15,"num":2.5,"sum":37.5},{"barcode":"ITEM000005","name":"方便面","unit":"袋","price":4.5,"num":3,"sum":9}];
